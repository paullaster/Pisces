 ...
 */
     async NIPush(transaction, checkoutId = undefined){
        try {
            ...
            if (transaction.TransactionType !== 'CustomerBuyGoodsOnline') {
                body.AccountReference = RandomCodeGenerator(10);
            }
            ...
            if (response.data.ResponseCode < 1 && checkoutId) {
                await this.model.create({
                    transId: body.AccountReference ? body.AccountReference : this.generateAccountNumber(),
