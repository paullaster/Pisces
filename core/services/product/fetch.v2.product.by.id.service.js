...
export class FetchByIdV2ProductService {
     ...
     */
    async execute(productId, query) {
        const rawProduct = await this.productRepository.fetchByIdForV2(productId, query);
        const linked = {
            categories: {},
            discounts: {},
            images: {},
        ...
        return { meta, data: product, linked };
    }
}
